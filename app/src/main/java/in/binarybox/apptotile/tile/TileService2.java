...
public class TileService2 extends TileService {
    ...
    private void updateTileDetailsFn(){
        ...
        Tile tile = getQsTile();
        tile.setLabel(sharedPreferences.getString("item2_app_name","no app"));
        tile.updateTile();
    }
    ...
    public void onClick() {
        ...
        Intent intent = packageManager.getLaunchIntentForPackage(sharedPreferences.getString("item2_package_name",getPackageName()));
